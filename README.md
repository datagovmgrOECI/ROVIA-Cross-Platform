...
To run ROVIA on your local computer (Windows/Linux/Mac OS machine), please follow the instructions mentioned in the UserGuide.pdf. The 'rovia.py' code must be used in conjunction with the model file that’s available to be downloaded from:
